...
app_ui <- function(){
    fluidPage(
        ...
        fluidRow(align="center",h1("AE Volcano Plot")),
        useShinyjs(),
        column(width=3,
               
               wellPanel(radioButtons("choose_input", "Input data", choices=c("Sample data", "User Upload"), selected = "Sample data", inline=TRUE)),
               conditionalPanel(condition = "input.choose_input=='User Upload'", 
                                #wellPanel(
               ...
               conditionalPanel(condition = "output.fileUploaded",
                                wellPanel(
                                    fluidRow(align="center",
                                             ...
                                             selectInput("period", "AE Relative to Exposure",choices = c("Treatment emergent", "AE during entire study"), width="75%"),
                                             ...
                                             hr(),
                                             selectInput("pvalue_label", "Scale for p-value",choices = c("None", "-log10"), selected="-log10",width="75%"),
                                             radioButtons("pvalue_adj_refline", "Show Adj p reference line?",choices = c("No", "Yes"), selected="No",width="75%", inline = TRUE)
               ...
               actionBttn("obtain", "Click to render Volcano Plot!",
